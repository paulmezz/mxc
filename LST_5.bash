...
#  obtain values to convert digital to radiance for band 6
LMAX6=${RADIANCE_MAXIMUM_BAND_6}
...
idl -e "FIRST_FILES_5, '$home/', '$directory/', '$imageBase', $year, $month, $day, $hour, $min, $sec,\
...
idl -e "SECOND_NARR_5, '$home/', '$directory/', $numPoints, $numHeights, $alb"
...
idl -e "THIRD_PIXELS_5, '$home/', '$directory/', '$imageBase', $numPoints, $numHeights,\
		         $landsatSamples, $landsatLines, $pixelSize, $zone,\
      		         $UL_EAST, $UL_NORTH, $UR_EAST, $UR_NORTH, $LL_EAST, $LL_NORTH, $LR_EAST, $LR_NORTH,\
              	  	 $UL_LAT, $UL_LON, $UR_LAT, $UR_LON, $LL_LAT, $LL_LON, $LR_LAT, $LR_LON,\
	       	         $LMAX6, $LMIN6, $QCALMAX6, $QCALMIN6, '$demFile'"
